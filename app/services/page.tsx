      ...
      <div className='container-wide space-y-8'>
        <header className='space-y-3'>
          ...
          <h1 className='section-heading text-[2rem] sm:text-[2.5rem] lg:text-[2.75rem]'>
            ...
            <span className='section-heading-accent'>business outcomes</span>
          </h1>
          <p className='max-w-4xl text-sm leading-[1.85] text-body md:text-base'>
            I provide structured implementation support for teams that need
            dependable full-stack execution, not short-term patchwork. Each
            engagement is scoped around outcomes: clearer user journeys,
            reliable system behavior, maintainable code, and measurable product
            progress across launch and post-launch stages.
          </p>
        </header>
        ...
        <div className='surface-muted p-5 md:p-6'>
          ...
          <p className='mt-2 text-sm leading-[1.8] text-body'>
            We start with goals, scope, and delivery constraints, then align on
            technical direction, milestones, and communication rhythm. This
            keeps implementation transparent and reduces surprises in timeline,
            feature quality, and production readiness.
          </p>
        </div>
